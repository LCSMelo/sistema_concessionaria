...
public class CadastrarCliente
{
    public void Cadastrarcliente()
    {
        ...
        if(!File.Exists(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\clientes.xls"))
        {
        ...
        else
        {
            ...
            ex.Workbooks.Open(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\clientes.xls");
            int contador = 1;
            do
            {
                contador += 1;
    ...
    {    
        ...
        ex.ActiveWorkbook.SaveAs(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\clientes.xls");
        ex.Quit();
        ex.Dispose();
    }
}     
