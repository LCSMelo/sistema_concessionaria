...
namespace sistema_concessionaria{
                    ...
                    {   
                        ...
                        {   
                            ...
                            case "2":
                                ...
                                parcelas1 = Convert.ToDouble(parcelas);
                                double precoparcela = preco/parcelas1; 
    ...
    public void Criarexcelvenda(double preco, string parcelas, string cl1, string cl2, string cl3, string cl4, string cl5, string cl6, string cr1, string cr2, string cr3, string cr4, string cr5, string cr6)
    {    
