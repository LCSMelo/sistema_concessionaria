...
namespace sistema_concessionaria{
    ...
    public class VenderCarro
    {
        public void Vendercarro()
        {
            ...
            ax.Workbooks.Open(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\clientes.xls");
            do
            {
                contador1 += 1;
            }
        ...
        if(!File.Exists(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\vendas.xls"))
        {
        ...
        else
        {
            ...
            ox.Workbooks.Open(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\vendas.xls");
            int contador3 = 1;
            do
            {
                contador3 += 1;
    ...
    {    
        ...
        ix.ActiveWorkbook.SaveAs(@"C:\Users\Fabio Freller\Documents\Programar\sistema_concessionaria\vendas.xls");
        ix.Quit();
        ix.Dispose();
    }
